...
public class MemberTest extends TestCase{
	...
	public void testgetInfo1(){
		try {
			MemberVO vo=MemberFactory.getMemberMaintainService("000001",UserRole.Enterprise).getInfo();
			assertNotNull(vo);
	...
	public void testgetInfo2(){
		try {
			MemberVO vo=MemberFactory.getMemberMaintainService("000001",UserRole.Member).getInfo();
			assertNull(vo);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//	}
	...
	public void testmodify(){
		try {
			...
			assertEquals(ResultMessage.Failure,MemberFactory.getMemberMaintainService("000001",UserRole.Enterprise).modifyInfo(vo));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
